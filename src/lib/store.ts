...
const getCandidates = async (callId: string, type: 'offer' | 'answer'): Promise<Candidate[]> => {
...
export const createCall = async (callId: string, offer: RTCSessionDescriptionInit): Promise<void> => {
...
export const addAnswer = async (callId: string, answer: RTCSessionDescriptionInit): Promise<void> => {
...
export const addCandidate = async (callId: string, candidate: Candidate, type: 'offer' | 'answer'): Promise<void> => {
    const candidateKey = `${callId}:${type}Candidates`;
